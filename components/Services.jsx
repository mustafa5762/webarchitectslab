  ...
  return (
    <div className='mt-40 px-[3vw] lg:px-[8vw]'>
        {services.map(service => 
            <div key={service} className='py-12 border-b border-[#E8AA42] flex items-center space-x-6'>
                <h3 className="text-4xl lg:text-7xl text-[#E57C23]">{service}</h3>
                <div className="border-l border-[#E8AA42] px-6 hidden">
